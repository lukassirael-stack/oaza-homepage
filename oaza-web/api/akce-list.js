...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const cols = 'id,slug,nazev,popis,datum_text,datum_od,datum_konec,misto,obrazek_url,platba_typ,cena_czk,cena_eur,kapacita,stav,poradi,prihlaska_url,prespani_nabidnout,prespani_cena_czk,prespani_cena_eur,vytvoreno,serie';
